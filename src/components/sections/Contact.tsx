...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/NanayakkaraMiniduThiranjaya',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/minidu-thiranjaya-988113320/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span>thiranjaya2003@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span>612/7,sapugaskanda Rd, Gonawala, Kelaniya.</span>
                </div>
              </div>
            </div>
